<template>
  <body class="overflow-y-hidden">
    <div class="2xl:mx-auto lg:py-16 lg:px-20 md:py-12 md:px-6 py-9 px-4">
      <p
        class="font-bold text-2xl mt-8 mb-8 leading-3 text-indigo-700 hover:text-indigo-800 cursor-pointer pb-2 text-left"
      >
        About
      </p>
      ...
      <div
        class="flex lg:flex-row flex-col md:gap-14 gap-16 justify-between lg:mt-20 mt-16"
      >
        <div class="w-full lg:w-6/12">
          <h2
